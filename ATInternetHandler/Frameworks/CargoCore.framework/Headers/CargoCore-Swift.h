...
SWIFT_MODULE_NAMESPACE_PUSH("CargoCore")

/// A class that provides a logger for Cargo
SWIFT_CLASS("_TtC9CargoCore9CARLogger")
@interface CARLogger : NSObject
...
SWIFT_CLASS("_TtC9CargoCore13CARTagHandler")
@interface CARTagHandler : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end


SWIFT_CLASS_NAMED("Cargo")
@interface SWIFTCargo : NSObject
...
///
/// returns:
/// an instance of Cargo object.
+ (SWIFTCargo * _Nonnull)getInstance SWIFT_WARN_UNUSED_RESULT;
@end


/// Create an Item object with this class in order to send item objects through Cargo
SWIFT_CLASS_NAMED("CargoItem")
@interface SWIFTCargoItem : NSObject
