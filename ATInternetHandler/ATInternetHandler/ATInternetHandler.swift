...
public class ATInternetHandler: CARTagHandler {
...
/* ************************************* SDK initialization ************************************* */
    ...
    fileprivate func initialize(_ parameters: [AnyHashable: Any]) {
    ...
    fileprivate func setConfig(parameters: [AnyHashable: Any]) {
...
/* ****************************************** Tracking ****************************************** */
    ...
    fileprivate func identify(parameters: [AnyHashable: Any]) {
...
/* ****************************************** Utility ******************************************* */
    ...
    fileprivate func setAdditionalScreenProperties(parameters: [AnyHashable: Any], screen: Screen) -> Screen {
        let screen = screen;
    ...
    fileprivate func setAdditionalEventProperties(parameters: [AnyHashable: Any], event: Gesture) -> Gesture {
        let event = event;
