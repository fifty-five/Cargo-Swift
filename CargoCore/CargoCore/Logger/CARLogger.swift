...
public class CARLogger: NSObject {
    ...
    public func carLog(_ intentLevel:LogLevelType, message:String){
    ...
    public func logMissingParam(_ paramName:String, methodName:String) {
    ...
    public func logUninitializedFramework() {
    ...
    public func logParamSetWithSuccess(_ paramName: String, value: Any) {
    ...
    public func logNotFoundValue(_ value: String, key: String, possibleValues: Array<Any>) {
        carLog(.warning,
    ...
    public func logReceivedFunction(_ tagName: String, parameters: [String: Any]) {
        carLog(.info,
    ...
    public func logUnknownFunctionTag(_ tagName: String) {
        carLog(.debug,
    ...
    public func logUncastableParam(_ paramName:String, type:String) {
        carLog(.error,
    ...
    public func logUnknownParam(_ paramName:String) {
