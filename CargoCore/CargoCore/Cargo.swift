...
public class Cargo: NSObject {
    ...
    @objc public static func getInstance() -> (Cargo) {
        if (instance == nil) {
            instance = Cargo();
        }
        return instance;
    ...
    public func registerHandler(_ tagHandler: CARTagHandler) {
    ...
    @objc internal func execute(_ parameters: [AnyHashable: Any]) {
